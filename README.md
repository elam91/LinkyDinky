...
LinkyDinky now has a graphical user interface! Download the latest macOS app from the [Releases page](../../releases).

No need to use the command line — just download, configure your settings, and run.
